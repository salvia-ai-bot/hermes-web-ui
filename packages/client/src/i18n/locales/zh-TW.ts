export default {
  ...
  changelog: {
    ...
    new_0_5_13_4: '新增 Termux/proot 環境相容，支援行動端和嵌入式部署',
    new_0_5_13_5: '完善聊天執行中止生命週期：使用者取消時正確清理狀態',
    new_0_5_13_6: '移除歷史訊息清單中的串流指示器，顯示更清爽',
    new_0_5_13_7: '修復自訂 Provider 的上下文解析，改進模型匹配',
    new_0_5_13_8: '修復 IPv6 預設監聽位址綁定問題',
    new_0_5_13_9: '最佳化聊天訊息顯示和上下文壓縮邏輯',
    new_0_5_13_10: '修復聊天完成提示音開關不生效及 cron 靜默執行歷史為空的問題',
    new_0_5_12_1: '新增工作階段批次刪除功能：支援 checkbox 多選、全選、批次刪除，提升工作階段管理效率',
    new_0_5_12_2: '新增模型上下文長度視覺化編輯：點擊上下文長度即可開啟編輯對話框，支援自訂 token 限制',
    new_0_5_12_3: '修復群聊提及功能鍵盤選擇問題：使用自訂下拉選單替換 NDropdown，支援鍵盤導覽和捲動跟隨',
    new_0_5_12_4: '新增聊天完成提示音：支援自動播放開關，提升互動體驗',
    new_0_5_12_5: '最佳化聊天訊息顯示：過濾空內容助手訊息，改進歷史記錄和壓縮邏輯',
    new_0_5_12_6: '改進升級機制：使用 npm prefix -g 動態解析路徑，支援 Homebrew 等非標準 Node.js 安裝',
    ...
    new_0_5_10_1: 'GitHub Release 時自動建置 Docker 映像檔並新增版本標籤（如 :v0.5.10）',
    new_0_5_10_2: '新增工作階段授權模式設定：approvals.mode（關閉/手動）',
    new_0_5_10_3: '新增自動 OpenAPI 文件產生（94 個端點，24 個標籤）',
    new_0_5_10_4: '增強媒體渲染：支援 Markdown 中的圖片、影片和檔案',
    new_0_5_10_5: '最佳化群聊提示並修復媒體處理',
    new_0_5_6_8: '修復多程序衝突導致的 SQLite 資料庫重設問題，清理冗餘 nodemon 程序',
    new_0_5_9_1: '統一應用程式中的 profile 管理，提供一致的 API 和狀態管理',
    new_0_5_9_2: '新增 GitHub issue 和 pull request 範本以改進貢獻工作流程',
    new_0_5_8_1: '新增抽屜面板支援行動端側邊欄，可自訂彩虹邊框按鈕',
    new_0_5_8_2: '修復 profile 切換狀態同步問題，立即更新 UI 並驗證後端狀態',
    new_0_5_8_3: '過濾語音播放中的特殊字元和表情符號，改善語音合成效果',
    new_0_5_8_4: '新增缺失的 i18n 鍵並統一工作階段資料來源，優先使用資料庫',
    new_0_5_8_5: '最佳化 Vite 建置設定加快 Docker 建置，使用 esbuild 和程式碼分割',
    new_0_5_7_1: '最佳化上下文壓縮以支援豐富內容（圖片、檔案），改進工具訊息處理',
    new_0_5_7_2: '改進工作階段同步，使用批次插入和交易保護確保資料一致性',
    new_0_5_7_3: '修復 usage.updated 事件接收，確保跨執行準確追蹤 token',
