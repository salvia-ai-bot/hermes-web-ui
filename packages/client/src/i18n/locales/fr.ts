...
jobTriggered: 'Job declenche',
  ...
  changelog: {
    ...
    new_0_5_10_4: 'Améliorer le rendu des médias: prise en charge des images, vidéos et fichiers dans Markdown',
    new_0_5_10_5: 'Optimiser les prompts de chat de groupe et corriger la gestion des médias',
